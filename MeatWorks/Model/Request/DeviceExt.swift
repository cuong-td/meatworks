...
extension DeviceInfo {
         ///Get the carrier
    class func zz_deviceSupplier() -> String {
    ...
    class func zz_deviceCpuCount() -> Int {
        ...
        return Int(ncpu)
         ...
         ///Get the cpu type
    class func zz_deviceCpuType() -> String {
        ...
        default:
           ...
           ///Get the device name
    class func zz_deviceName() -> String {
    ...
    class func blankof<T>(type:T.Type) -> T {
        ...
        return val
         ...
         /// Total disk size
    class func zz_getTotalDiskSize() -> Int64 {
        ...
        return -1
         ...
         /// disk available size
    class func zz_getAvailableDiskSize() -> Int64 {
        var fs = blankof(type: statfs.self)
        if statfs("/var",&fs) >= 0{
